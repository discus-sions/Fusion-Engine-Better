...
class LoadReplayState extends MusicBeatState
{
    ...
    var songs:Array<FreeplayState.SongMetadatas> = [];
    ...
    public function getWeekNumbFromSong(songName:String):Int
    {
        ...
        {
            var pog:FreeplayState.SongMetadatas = songs[i];
	...
	public function addSong(songName:String, weekNum:Int, songCharacter:String)
        {
            songs.push(new FreeplayState.SongMetadatas(songName, weekNum, songCharacter));
        }
